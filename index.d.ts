...
declare type EleventyConfig = {
  addCollection: (name: string, collection: Array<string> | ((collection: Collection) => Array<string>)) => void;
  addFilter: (name: string, filterFunction: (...args: any) => string | string[]) => void;
  addPlugin: (plugin: unknown, options?: Record<string, unknown>) => void;
  addShortcode: (name: string, shortcodeFunction: (...args: any) => string) => void;
  addTransform: (name: string, transformFunction: (content: string, outputPath: string) => string) => void;
  ...
  setBrowserSyncConfig: (config: { callbacks: { ready: (error: Error, browserSync: any) => void } }) => void;
};
